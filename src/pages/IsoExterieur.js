...
function IsoExterieur() {
  return (
    <Container>
      ...
      <Typography variant='h1' color='primary' fontWeight='bold' textAlign='center' marginTop={'70px'} padding={'1rem'}>Isolation Thermique Extérieure</Typography>
      <div style={{textAlign: 'center'}}><video src={video} controls loop autoPlay muted></video></div>
      <Typography variant='h5' color='primary'>Principe et fonctionnement de l'isolation des murs par l'extérieur</Typography>
