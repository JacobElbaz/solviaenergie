...
function PACAirAir() {
  return (
    <Container>
      ...
      <Typography variant='h4' color='primary'>Vos factures de chauffage divisées par 3 !​​</Typography>
      <Typography>
En utilisant l’énergie gratuite de l’air, vous ne payez que l'électricité nécessaire à la circulation du fluide caloporteur pour faire fonctionner la pompe à chaleur. Vous pouvez ainsi diviser vos factures de chauffage par 3. Ces économies permettent d’amortir en seulement quelques années le prix de la pompe à chaleur air-air qui varie entre 1.600 € et 2.800 € par unité intérieure installée.</Typography>
      <Typography variant='h4' color='primary'>​​​Puis-je installer une PAC air-air chez moi ?</Typography>
      ...
      <Typography variant='h4' color='primary'>ATTENTION IMPORTANT !!</Typography>
