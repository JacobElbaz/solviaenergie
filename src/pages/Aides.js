...
function Aides() {
  return (
    <Container>
      ...
      <Typography variant='h1' color='primary' fontWeight='bold' textAlign='center' marginTop='70px' padding={'1rem'}>Aides et subventions 2023</Typography>
      <Typography variant='h2' color='secondary' textAlign='center' marginY='50px'>Rénovation énergétique : les aides auxquelles vous pouvez prétendre</Typography>
